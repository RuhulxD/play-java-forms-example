...
public class OmdbVideoFull extends OmdbVideoBasic implements Serializable {
    ...
    public OmdbVideoFull(@Constraints.Required String title, @Constraints.Required String year, @Constraints.Required String type, String poster, @Constraints.Required String genre, String actors) {
        super(title, year, type, poster);
        this.genre = genre;
        this.actors = actors;
    }
